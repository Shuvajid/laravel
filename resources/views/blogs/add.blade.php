...
<html lang="en">
  ...
  <div class="container">
    <div class="row">
        <div class="col-md-12">
            <h3 align="center">Please Add Your Blog Details </h3>
        ...
        <div class="mb-3">
          ...
          <textarea class="form-control"name="blogdes"placeholder="Blog Description"  rows="3"></textarea>
        </div>
        
        <div class="d-grid gap-2">
  
          <button type="submit" class="btn btn-primary" type="button">Add Blog</button>
        </div>
             </form>
        </div>
